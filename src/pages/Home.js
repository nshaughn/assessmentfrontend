...
function Home({
  ...
  function openLoginModal() {
    showLoginStateModal(true);
  }
  function openRegisterModal() {
    showRegisterStateModal(true);
  }
  function closeLoginModal() {
    showLoginStateModal(false);
  }
  function closeRegisterModal() {
    showRegisterStateModal(false);
  }
  ...
  return (
    <div className="master">
      <div className="header_bar" sx={{ bg: "headerBar" }}>
        <img
          className="logo_img"
          src={require("../images/smoothie_logo_v1.png")}
          alt="logo"
        />
        {!user ? (
    ...
    return (
      ...
      <div className="offers_container" sx={{bg: 'offersContainer'}}>
        ...
        <div className="offers offers_red">
          <div class="desktop">
            <img
              src={require("../images/smoothie_offers/smoothie_red.png")}
              alt="Red Smoothie"
            />
          </div>
          <div class="mobile">
        ...
        <div className="offers offers_mixed">
          <div class="desktop">
            <img
              src={require("../images/smoothie_offers/smoothie_mixed.png")}
              alt="Mixed smoothie"
            />
          </div>
          <div class="mobile">
        ...
        <div className="offers offers_yellow">
          <div class="desktop">
            <img
              src={require("../images/smoothie_offers/smoothie_yellow.png")}
              alt="Yellow Smoothie"
            />
          </div>
          <div class="mobile">
      ...
      {!user ? (
        <>
          <UserModal
            ...
            toggle={toggle}
            setToggle={setToggle}
            loginStateModal={loginStateModal}
            registerStateModal={registerStateModal}
            showRegisterStateModal={showRegisterStateModal}
          ...
          <div className="splashPage" sx={{bg: 'splashPage'}}>
            <div className="innerCont">
              ...
              <div className="animationFront"></div>
            </div>
          </div>
        </>
      ) : (
